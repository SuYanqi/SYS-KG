...
<div>
  ...
  <!-- <table class="table table-hover" v-html="tableHtml"> </table>   -->
...
import BugReportTable from "./BugReportTable_ago.vue";
...
export default {
  ...
  //       axios.post("http://localhost:5000/", input_val)
    ...
    showBugTable(){
      ...
      //   // console.log(steps[i]);
        this.stepHtml += "<el-collapse-item title='" + "Title" + "' name='"+ (i + 1) + "'>" +
                    "<div>"+ steps[i] + "</div> </el-collapse-item>"
      }
